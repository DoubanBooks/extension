  ...
  function insertPriceCardBefore(targetElement, isbn) {
    ...
    cardContainer.innerHTML = `
      <div class="buyinfo-printed">
        ...
        <p style="text-align: center; color: #999; font-size: 13px; margin-top: 12px; padding-top: 12px; border-top: 1px solid #eaeaea;">Powered by <a href="https://github.com/DoubanBooks/extension/releases" target="_blank" class="footer-link">豆瓣读书++</a></p>
      </div>
    `;
